  ...
  <body>
    ...
    $(document).ready(function() {
        ...
        $('#sample_form').on('submit', function(event){
            ...
            if($('#action').val() == "Add"){
                ...
                $.ajax({
                    url:"http://localhost/portofolio-boostrap5/si-admin/api/users/create.php",
                    method:"POST",
                ...
                $.ajax({
                    url:"http://localhost/portofolio-boostrap5/si-admin/api/users/update.php",
                    method:"PUT",
                    data: JSON.stringify(formData),
                    success:function(data){
                        $('#action_button').attr('disabled', false);
    ...
    function showAll() {
        $.ajax({
            ...
            url:"http://localhost/portofolio-boostrap5/si-admin/api/users/read.php",
    ...
    function showOne(id) {
        ...
        $.ajax({
            ...
            contentType: "application/json",
            url:
            "http://localhost/portofolio-boostrap5/si-admin/api/users/read.php?id="+id,
            success: function(response) {
                $('#id').val(response.id);
    ...
    function deleteOne(id) {
        ...
        if(konfirHapus){
            $.ajax({
            url:"http://localhost/portofolio-boostrap5/si-admin/api/users/delete.php",
            method:"DELETE",
