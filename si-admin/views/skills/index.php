...
//     return header('Location: http://localhost/portofolio-boostrap5/si-admin/views/Login/');
// }
?>
<!doctype html>
<html lang="en">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sample_form').on('submit', function(event) {
                ...
                if ($('#action').val() == "Add") {
                    ...
                    $.ajax({
                        url: "http://localhost/portofolio-boostrap5/si-admin/api/skills/create.php",
                        method: "POST",
                    ...
                    $.ajax({
                        url: "http://localhost/portofolio-boostrap5/si-admin/api/skills/update.php",
                        method: "PUT",
                        data: JSON.stringify(formData),
                        success: function(data) {
                            $('#action_button').attr('disabled', false);
        ...
        function showAll() {
            $.ajax({
                ...
                url: "http://localhost/portofolio-boostrap5/si-admin/api/skills/read.php",
        ...
        function showOne(id) {
            ...
            $.ajax({
                type: "GET",
                contentType: "application/json",
                url: "http://localhost/portofolio-boostrap5/si-admin/api/skills/read.php?id=" + id,
                success: function(response) {
                    $('#id').val(response.id);
        ...
        function deleteOne(id) {
            ...
            if (konfirmasiUser) {
                $.ajax({
                    url: "http://localhost/portofolio-boostrap5/si-admin/api/skills/delete.php",
                    method: "DELETE",
                    data: JSON.stringify({
                        id: id,
                    }),
